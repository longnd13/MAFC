...
(function ($) {
    ...
    $.fn.fileinputLocales['vi'] = {
        ...
        browseLabel: 'Chọn hình ảnh &hellip;',
        removeLabel: 'Gỡ bỏ',
        ...
        msgFilesTooMany: 'Số lượng hình ảnh upload là <b>({n})</b> vượt quá giới hạn cho phép là <b>{m}</b> hình ảnh.',
